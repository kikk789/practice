...
public class UserInfo {
	...
	private String userLeftSight;
	private String userRightSight;
	...
	public String getUserLeftSight() {
		return userLeftSight;
	}
	public void setUserLeftSight(String userLeftSight) {
		this.userLeftSight = userLeftSight;
	}
	public String getUserRightSight() {
		return userRightSight;
	}
	public void setUserRightSight(String userRightSight) {
		this.userRightSight = userRightSight;
	}
