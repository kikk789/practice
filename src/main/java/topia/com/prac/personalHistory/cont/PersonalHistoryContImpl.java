...
//			}
	...
	@ResponseBody
	public int imgInsert(MultipartFile file, String userName, Image image, HttpServletRequest request) throws IllegalStateException, IOException {
		log.info("*******************/imgInsert************************");
		String realPath = request.getRealPath("upload");//일단 사용 안함
		return personalHistoryServ.imgInsert(file,userName,image,realPath);
	}
