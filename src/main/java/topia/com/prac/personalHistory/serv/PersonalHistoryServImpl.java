...
public class PersonalHistoryServImpl implements PersonalHistoryServ {
	...
	public HashMap<String, Object> userList(HashMap<String, Object> reqMap) {
		log.info("SERVICE==========ReqMap=========userList");
		...
		//containsKey == 해당 Key가 존재할 경우 true 반환

			try {
				String userCareerLength="";
				String keywords=""; //#해시태그 개념
				String userGender="";

				String maritalStatusSelect="";
				String userListSearchPeriod="";

				if(reqMap.containsKey("userCareerLength")==true) {
					userCareerLength = ((String[]) reqMap.get("userCareerLength"))[0];
				...
				if(reqMap.containsKey("keywords")==true) {
					keywords = ((String[]) reqMap.get("keywords"))[0];
					if (keywords.equals("")) {
						keywords = null;
				...
				if(reqMap.containsKey("userGender")==true) {
				...
				if(reqMap.containsKey("maritalStatusSelect")==true) {
					maritalStatusSelect = ((String[]) reqMap.get("maritalStatusSelect"))[0];
					if(maritalStatusSelect.equals("")){
						maritalStatusSelect = null;
						reqMap.put("maritalStatusSelect",maritalStatusSelect);
					}
				}else{
					maritalStatusSelect = null;
					reqMap.put("maritalStatusSelect",maritalStatusSelect);
				...
				if(reqMap.containsKey("userListSearchPeriod")!=true) {
...
//			reqMap.put("keywords", null);
//			reqMap.put("userGender", null);
//			reqMap.put("userCareerLength", null);
//			reqMap.put("maritalStatusSelect",null);
//			reqMap.put("userListSearchWord", null);
//			reqMap.put("userListSearchPeriod", null);

		//System.out.println("reqMap.get(\"maritalStatusSelect\") " +reqMap.get("maritalStatusSelect"));
	 ...
	 * 
	 * @param inputdata : map �삎�깭�쓽 怨좎젙�뜲�씠�꽣�� json string �삎�깭�쓽 �쑀�룞�뜲�씠�꽣 �룷�븿
	...
	public HashMap<String, Object> getRegisterData(Map<String, Object> reqMap)
		...
		HashMap<String, Object> resMap = new HashMap<String, Object>();
		log.info("SERVICE==========ReqMap=========getRegisterData");
		for(String key: reqMap.keySet()) {
			log.info("{}: {}",key, reqMap.get(key));
		}
	...
	@Override
	public int imgInsert(MultipartFile file, String userName, Image image, String realPath) throws IllegalStateException, IOException {
		
		//String path = "C:\\Users\\gaebal\\Documents\\workspace-sts-3.9.18.RELEASE\\practice\\src\\main\\webapp\\upload";
