	...
	<div class="user-info-list-pannel">
		...
		<table class="user-info-table3">
			<tbody>
				...
				<tr>
					<td><input type="text" id="userBloodtype" placeholder="영어만 입력(ex- A형 = A)"></td>
					<td><input type="number" id="userWeight" placeholder="숫자만 입력(ex-100kg = 100)" maxlength='3'></td>
					<td><input type="text" id="userLeftSight" placeholder="좌 시력(2.0)" maxlength='3'></td>
					<td><input type="text" id="userRightSight" placeholder="우 시력(2.0)" maxlength='3'></td>
				</tr>
			</tbody>
		</table>
